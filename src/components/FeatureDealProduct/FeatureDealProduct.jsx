...
class    FeatureDealProduct extends React.Component {
        ...
        <div className="product-grid4">
          ...
          <div className="image-holder">
            <a href="../home/singleproduct">
             ...
             <img className="pic-1" src={require("../../img/img-3.jpg")} />

              <img className="pic-2" src={require("../../img/img-4.jpg")} />
            ...
            <span className="product-new-label">Discount 25%</span>
            <a href="#">
<span className="product-discount-label">
<Icon type="heart" /></span>
</a>
<a href="#">
 <span className="product-discount-label2"><Icon type="eye" /></span>
 </a>
...
25cm distance -  More Devices .</a></h3>
            <div className="price">
            9000.00 L.E
            </div>
...
export default   FeatureDealProduct
;
